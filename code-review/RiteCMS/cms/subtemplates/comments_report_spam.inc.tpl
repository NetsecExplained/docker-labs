<h1><a href="<?php echo CMSHOME;?>"><?php echo $lang['administration']; ?></a> &raquo; <a href="<?php echo CMSHOME;?>?mode=comments"><?php echo $lang['comments']; ?></a> &raquo; <?php echo $lang['report_spam']; ?></h1>
