<h1><a href="<?php echo CMSHOME;?>"><?php echo $lang['administration']; ?></a> &raquo; <a href="<?php echo CMSHOME;?>?mode=galleries"><?php echo $lang['photo_galleries']; ?></a> &raquo; <a href="<?php echo CMSHOME;?>?mode=galleries&amp;edit=<?php echo $gallery; ?>"><?php echo str_replace('[gallery]',$gallery,$lang['edit_gallery']); ?></a> &raquo; <?php echo $lang['gallery_properties']; ?></h1>

<form action="<?php echo CMSHOME;?>" method="post"><div>
 <div>
