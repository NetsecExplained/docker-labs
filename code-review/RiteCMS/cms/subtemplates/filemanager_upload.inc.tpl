<h1><a href="<?php echo CMSHOME;?>"><?php echo $lang['administration']; ?></a> &raquo; <a href="<?php echo CMSHOME;?>?mode=filemanager"><?php echo $lang['filemanager']; ?></a> &raquo; <?php echo $lang['upload_file']; ?></h1>
