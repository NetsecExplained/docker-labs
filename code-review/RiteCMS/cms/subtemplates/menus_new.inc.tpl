<h1><a href="<?php echo CMSHOME;?>"><?php echo $lang['administration']; ?></a> &raquo; <a href="<?php echo CMSHOME;?>?mode=menus"><?php echo $lang['menus']; ?></a> &raquo; <?php echo $lang['new_menu_hl']; ?></h1>
